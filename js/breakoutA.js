 ...
 */
function preload() {
    game.load.atlas('breakout', '/resources/breakout.png',
...
function create() {
    ...
    paddle = game.add.sprite(game.world.centerX, 500,
        'paddle');
    ...
    ball = game.add.sprite(game.world.centerX, paddle.y - 14,
        'breakout', 'ball_1.png');
    ball.anchor.set(0.5);
    ...
    ball.animations.add('spin', ['ball_1.png', 'ball_2.png',
        'ball_3.png', 'ball_4.png', 'ball_5.png'], 50, true, false);
